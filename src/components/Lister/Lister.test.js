...
describe('<Lister />', () => {
    ...
    describe('when no posts are available', () => {
        ...
        it('should show the reset button', async () => {
            const container = render(<Lister />);

            await waitForElementToBeRemoved(() => container.getByText('Loading...'))
            expect(container.getByRole('button', { name: 'Reset' })).toBeInTheDocument();
        });
    ...
    describe('when posts exist', () => {
        ...
        it('should display posts when they exist', async () => {
            ...
            expect(container.getByText('Posted by: ' + firstPost.author)).toBeInTheDocument();
            ...
            expect(container.getByText('Posted by: ' + secondPost.author)).toBeInTheDocument();
        });
